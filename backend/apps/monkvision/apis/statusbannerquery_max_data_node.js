...
exports.doService = async jsonReq => {
    ...
    if (parseFloat(threshold) > parseFloat(truePercent)) textexplanation = `${currentData.common_name} - ${currentData.node_hostname}:${currentData.node_port}, Threshold at: ${threshold}`;
    else textexplanation = `${currentData.common_name} - ${currentData.node_hostname}:${currentData.node_port}, Threshold at: ${threshold}`;
